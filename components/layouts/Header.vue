  ...
  <div class="flex flex-col relative items-center rounded-lg glass bg-cover lg:card-side text-neutral-content mt-20 lg:mt-0 mx-4 lg:mx-0 p-4">
    ...
    <div class="max-w-md card-body flex flex-col flex-auto lg:mr-auto mr-0">
      ...
      <ul>
        ...
        <li>
          Ville actuelle : Lille (59)
        </li>
        <li>
          Hobbies : jeux-vidéo, Voiture, Dév
        </li>
      </ul>
      <p class="mt-4">
        Je suis autodidacte depuis toujours, je suis passionné par l'informatique, mais surtout la programmation Web, j'ai beaucoup appris via divers sites comme openclassroom (Anciennement siteduzero.com), mais aussi via des projets de jeux (World of Warcraft, Minecraft, Dofus).
