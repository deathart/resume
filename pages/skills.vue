<template>
  <div class="bg-gray-300 dark:bg-base-200 rounded-lg p-4 mx-4 lg:mx-0">
    ...
    <section class="rounded-lg flex flex-col relative overflow-hidden text-indigo-200 body-font p-5 bg-gray-900 backdrop-filter backdrop-blur-lg bg-opacity-20">
      <div class="mx-auto flex px-5 lg:flex-row flex-col items-center justify-between">
        <div class="lg:flex-grow lg:w-2/3 lg:pr-24 pr-0 flex flex-col lg:items-start lg:text-left text-center mb-16 lg:mb-0 items-center">
          <div class="pt-10 px-2 lg:px-6">
        ...
        <div class="lg:max-w-lg lg:w-1/3 w-5/6 lg:block hidden">
    ...
    <section class="rounded-lg flex flex-col relative overflow-hidden text-indigo-200 body-font p-5 bg-gray-900 backdrop-filter backdrop-blur-lg bg-opacity-20 mt-4">
      <div class="mx-auto flex px-5 lg:flex-row flex-col items-center justify-between">
        ...
        <div class="lg:flex-grow lg:w-2/3 lg:pl-24 pl-0 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0">
          <div class="pt-10 px-2 lg:px-6 flex flex-col justify-end lg:ml-auto ml-0">
            <h1 class="title-font lg:text-4xl text-3xl mb-4 font-medium text-gray-100 text-right">
              Back-end
            </h1>
            <div class="flex flex-col lg:flex-row">
              <div class="lg:flex-grow lg:w-1/3 w-full flex flex-col">
                <p class="mb-4 text-sm text-gray-600">
                  Languages
                </p>
                <div class="flex justify-between items-center">
              ...
              <div class="lg:flex-grow lg:w-1/3 w-full flex flex-col lg:ml-12 ml-0">
                <p class="mb-4 text-sm text-gray-600">
                  Framework & outils
                </p>
                <div class="flex justify-between items-center">
    ...
    <section class="rounded-lg flex flex-col relative overflow-hidden text-indigo-200 body-font p-5 bg-gray-900 backdrop-filter backdrop-blur-lg bg-opacity-20 mt-4">
      <div class="mx-auto flex px-5 lg:flex-row flex-col items-center justify-between">
        <div class="lg:flex-grow lg:w-2/3 pr-24 pr-0 flex flex-col lg:items-start lg:text-left mb-16 lg:mb-0 items-center">
          <div class="visible">
            <div class="pt-10 lg:px-2 px-6">
              <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">
                Infra & Matériel
              </h1>
              <div class="flex flex-col lg:flex-row">
